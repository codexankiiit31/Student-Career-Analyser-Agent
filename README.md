...
Career Advisor & Analyzer is an AI-powered assistant that helps users evaluate their resumes, understand job market trends, and receive personalized career guidance.

The system uses a chat-driven interface where users can upload their resume, ask career-related questions, and receive intelligent insights generated by AI models.
